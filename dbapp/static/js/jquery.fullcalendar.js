...
!function($) {
    ...
    CalendarApp.prototype.onSelect = function (start, end, allDay) {
        var $this = this;
            ...
            form.find(".row")
                ...
                .append("<option value='bg-primary'>Danger</option>")
    ...
    CalendarApp.prototype.init = function() {
        ...
        var defaultEvents =  [{
                ...
                className: 'bg-[#7460ee] border border-[#7460ee] rounded-sm text-[13px] mx-[7px] my-[1px] p-[5px] text-center'
            },
            {
                title: 'Test Event 1',
                start: today,
                end: today,
                className: 'bg-success border border-success rounded-sm text-[13px] mx-[7px] my-[1px] p-[5px] text-center'
            },
            {
                title: 'Test Event 2',
                start: new Date($.now() + 168000000),
                className: 'bg-[#009efb] border border-[#009efb] rounded-sm text-[13px] mx-[7px] my-[1px] p-[5px] text-center'
            },
            {
                title: 'Test Event 3',
                start: new Date($.now() + 338000000),
                className: 'bg-primary border border-primary rounded-sm text-[13px] mx-[7px] my-[1px] p-[5px] text-center'
            }];
